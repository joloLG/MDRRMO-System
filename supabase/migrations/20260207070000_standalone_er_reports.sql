-- Create standalone_er_reports table for ER Team to submit additional PCR reports
-- These are independent reports not tied to emergency_reports from public users
...
CREATE INDEX idx_standalone_er_reports_er_team ON standalone_er_reports(er_team_id);
CREATE INDEX idx_standalone_er_reports_submitted_by ON standalone_er_reports(submitted_by);
CREATE INDEX idx_standalone_er_reports_status ON standalone_er_reports(status);
CREATE INDEX idx_standalone_er_reports_created_at ON standalone_er_reports(created_at DESC);
CREATE INDEX idx_standalone_er_reports_report_date ON standalone_er_reports(report_date DESC);
